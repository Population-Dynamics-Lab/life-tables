...
```{r}
# Download, cache and read the Ontario female survivorship data from period life tables for females
dir.create("data-cache", showWarnings = FALSE)
fem_lt_url <- "http://www.prdh.umontreal.ca/BDLC/data/ont/fltper_5x5.txt"
...
deaths_url <- "https://www.prdh.umontreal.ca/BDLC/data/ont/Deaths_5x1.txt"
...
deaths <- tryCatch(
  ...
  error = function(e) readr::read_table(deaths_file_path, skip = 2, col_types = "ccddd")
)
```

```{r}
# Download, cache, and read the population data
pop_url <- "https://www.prdh.umontreal.ca/BDLC/data/ont/Population5.txt"
...
pop <- tryCatch(
  ...
  error = function(e) readr::read_table(pop_file_path, skip = 2, col_types = "ccddd")
)
```
